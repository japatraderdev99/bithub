  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === "right" && "inset-y-0 right-0 h-full w-3/4 sm:max-w-lg border-l overflow-y-auto",
        side === "left" && "inset-y-0 left-0 h-full w-3/4 sm:max-w-sm border-r overflow-y-auto",
        className
      )}
      {...props}
    >
